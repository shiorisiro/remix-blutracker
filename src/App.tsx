          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex items-center gap-2 flex-1 justify-end">
              {user && (
                <button 
                  onClick={logout}
                  className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl text-xs font-semibold hover:bg-gray-100/50 dark:hover:bg-gray-800/40 transition-all duration-200 cursor-pointer active:scale-95 text-red-500 dark:text-red-400"
                >
            ...
            <section className="bg-white dark:bg-[#13161A] p-6 rounded-[32px] border border-gray-100 dark:border-[#22272F] transition-all">
              <div className="flex justify-between items-center mb-6">
                ...
                <button 
                  ...
                  className="text-gray-500 hover:text-black dark:text-gray-400 dark:hover:text-[#CFFF0F] text-xs font-bold font-display flex items-center gap-0.5 transition-colors cursor-pointer"
                >
...
/>
            ...
            <section className="space-y-4">
              <div className="flex justify-between items-center px-1">
                <h3 className="font-extrabold text-xs text-gray-400 dark:text-gray-500 uppercase tracking-widest font-display">Transaksi Terakhir</h3>
                <button 
                  onClick={() => setActiveTab('history')}
                  className="text-gray-500 hover:text-black dark:text-gray-400 dark:hover:text-[#CFFF0F] text-xs font-bold font-display uppercase tracking-wider transition-colors cursor-pointer"
                >
                  Lihat Semua
                </button>
              </div>
          ...
          <section className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl p-4 shadow-sm space-y-3 transition-colors duration-200">
              <div className="grid grid-cols-3 gap-2">
                ...
                <button
                  onClick={() => setActiveHistoryTool(activeHistoryTool === 'delete' ? 'none' : 'delete')}
                  className={cn(
                    "flex flex-col items-center justify-center py-2.5 px-2 rounded-2xl border text-xs font-semibold gap-1.5 transition-all select-none cursor-pointer",
                    activeHistoryTool === 'delete'
                      ? "bg-red-50 dark:bg-red-950/20 border-red-200 dark:border-red-900/50 text-red-500 dark:text-red-400 font-bold"
                      : "bg-gray-50 dark:bg-gray-950/50 hover:bg-gray-50 dark:bg-gray-800/40 dark:hover:bg-gray-800 border-gray-100 dark:border-gray-800 text-gray-500 dark:text-gray-400"
                  )}
                >
                  <Trash2 size={18} />
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-2">
                <button 
                  onClick={toggleTheme}
                  className="p-2 bg-white dark:bg-gray-900 rounded-xl shadow-sm text-gray-500 hover:text-blu-primary dark:text-gray-400 transition-colors flex items-center justify-center cursor-pointer"
                  title={theme === 'light' ? 'Mode Gelap' : 'Mode Terang'}
                >
      ...
      <AnimatePresence>
        {isStatsDetailOpen && (
        <StatsDetailModal 
          setIsStatsDetailOpen={setIsStatsDetailOpen}
